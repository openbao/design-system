...
let HdsPaginationNumberedIndexComponent = (_class = class HdsPaginationNumberedIndexComponent extends Component {
  ...
  constructor() {
    ...
    _initializerDefineProperty(this, "_currentPage", _descriptor2, this);
    _initializerDefineProperty(this, "_currentPageSize", _descriptor3, this);
    _initializerDefineProperty(this, "isControlled", _descriptor4, this);
  ...
  writable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "_currentPage", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "_currentPageSize", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
...
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "isControlled", [tracked], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
