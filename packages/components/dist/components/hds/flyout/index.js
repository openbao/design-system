...
let HdsFlyoutIndexComponent = (_class = class HdsFlyoutIndexComponent extends Component {
  ...
  didInsert(element) {
    ...
    if (!element.showModal) {
      Promise.all([import('dialog-polyfill'), import('dialog-polyfill-css')]).then(([dialogPolyfill]) => {
